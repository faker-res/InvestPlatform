...
//    @Pointcut("execution(public * la.niub.abcapi.invest.seller.service.impl.*.*(..))" +
//            "|| execution(public * la.niub.abcapi.invest.seller.dao.*.*.*(..))")
    @Pointcut("execution(public * la.niub..*.*(..))")
    public void pointCut(){}

    @Before("execution(* la.niub.abcapi.invest.seller.controller..*.*(..))")
    ...
    @After("execution(* la.niub.abcapi.invest.seller.controller..*.*(..))")
