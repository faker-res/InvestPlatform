package la.niub.abcapi.invest.platform.component.interceptor;
...
//    @Pointcut("execution(public * la.niub.abcapi.invest.platform.service.impl.*.*(..))" +
//            "|| execution(public * la.niub.abcapi.invest.platform.dao.*.*.*(..))")
    @Pointcut("execution(public * la.niub..*.*(..))")
    public void pointCut(){}

    @Before("execution(* la.niub.abcapi.invest.platform.controller..*.*(..))")
    ...
    @After("execution(* la.niub.abcapi.invest.platform.controller..*.*(..))")
