...
public class InvestnewBrokerModel implements Serializable {
    ...
    public InvestnewBrokerModel(Long org_uni_code, String org_name, String org_sname) {
        this.org_uni_code = org_uni_code;
        this.org_name = org_name;
        this.org_sname = org_sname;
    }

    public InvestnewBrokerModel(Long org_uni_code, String org_name, String org_sname, String synonym) {
        this.org_uni_code = org_uni_code;
        this.org_name = org_name;
        this.org_sname = org_sname;
