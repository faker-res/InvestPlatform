...
//
//@Configuration
//public class MongoModelingResConfiguration {
//
//    @Value("${spring.application.name}")
//    private String applicationName;
//
//    @Value("${spring.data.mongodb.modelingRes.uri}")
//    private String uri;
//
//    @Value("${spring.data.mongodb.modelingRes.timeout}")
//    private Integer timeout;
//
//    public final static String NAME = "modelingResMongo";
//
//    @Primary
//    @Bean(name = NAME)
