...
export PROJECT_NAME=service-invest-seller
...
export ENV=$1
export SERVER_PORT=9901
export PROJECT_PATH=service-invest-seller
...
echo " Current ENV is : " $1
echo ' Current service list = ': ${SERVER_LIST[*]}
