...
public class SecBasicInfoResponse implements Serializable {
    ...
    public SecBasicInfoResponse(String sec_code, String abc_code) {
        this.sec_code = sec_code;
        this.abc_code = abc_code;
    }

    public SecBasicInfoResponse() {
        super();
    }
